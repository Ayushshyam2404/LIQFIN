...
exports.parseTransactionEmail = exports.classifyMerchantCategory = void 0;
// Map merchants to standard categories
const classifyMerchantCategory = (merchant) => {
...
exports.classifyMerchantCategory = classifyMerchantCategory;
// Regex parser to extract banking emails data
const parseTransactionEmail = (emailContent) => {
    try {
        // 1. Extract Amount
        ...
        // 6. Extract Category
        const category = (0, exports.classifyMerchantCategory)(merchantName);
        return {
            amount: baseAmount,
...
exports.parseTransactionEmail = parseTransactionEmail;
